...
For more details on how LINQ to Twitter works, you can visit [[Making API Calls]] for API specific examples.  The downloadable source code also contains copious examples in the projects. Just look in the _Samples_ folder.
