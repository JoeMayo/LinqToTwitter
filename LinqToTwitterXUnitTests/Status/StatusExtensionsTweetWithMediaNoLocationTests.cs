...
namespace LinqToTwitterXUnitTests.StatusTests
{
    ...
    <status>
      ...
      <geo />
        ...
        public void TweetWithMedia_Without_Location_Params_Throws_On_Null_Status()
        {
            ...
            Assert.Throws<ArgumentNullException>(() =>
            {
                StatusExtensions.TweetWithMedia(
                    this.twitterCtx.Object, this.status, this.possiblySensitive, this.mediaItems);
            });
        ...
        [Fact]
        public void TweetWithMedia_Without_Location_Params_Calls_TwitterContext_CreateRequestProcessor()
        {
            StatusExtensions.TweetWithMedia(
                this.twitterCtx.Object, this.status, this.possiblySensitive, this.mediaItems);
