...
namespace LinqToTwitterXUnitTests.ListTests
{
    public class ListRequestProcessorTests
    {
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists.json?screen_name=JoeMayo";
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/all.json?screen_name=JoeMayo";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/all.json?user_id=123";
            var listReqProc = new ListRequestProcessor<List> { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists.json?user_id=123&screen_name=JoeMayo&cursor=456";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
                { "Type", ((int) ListType.Lists).ToString() },
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/memberships.json?user_id=123&screen_name=JoeMayo&cursor=456&filter_to_owned_lists=true";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
                { "Type", ((int) ListType.Memberships).ToString() },
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/memberships.json?user_id=123&screen_name=JoeMayo&cursor=456";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
                { "Type", ((int) ListType.Memberships).ToString() },
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/subscriptions.json?user_id=123&screen_name=JoeMayo&cursor=456";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
                { "Type", ((int) ListType.Subscriptions).ToString() },
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/show.json?slug=test&owner_id=123&owner_screen_name=JoeMayo&list_id=456";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
                { "Type", ((int) ListType.Show).ToString() },
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/statuses.json?owner_id=123&owner_screen_name=JoeMayo&slug=test&list_id=456&since_id=789&max_id=234&count=25&per_page=25&page=3&trim_user=true&include_entities=true&include_rts=true";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
                { "Type", ((int) ListType.Statuses).ToString() },
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/statuses.json?owner_id=123&owner_screen_name=JoeMayo&slug=test&list_id=456&since_id=789&max_id=234&count=25&per_page=25&page=3";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
                { "Type", ((int) ListType.Statuses).ToString() },
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/members.json?owner_id=123&owner_screen_name=JoeMayo&slug=test&list_id=456&cursor=789";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
                { "Type", ((int) ListType.Members).ToString() },
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/members/show.json?user_id=789&screen_name=JoeMayo&slug=test&owner_id=123&owner_screen_name=JoeMayo&list_id=456";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
                { "Type", ((int) ListType.IsMember).ToString() },
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/subscribers.json?owner_id=123&owner_screen_name=JoeMayo&slug=test&list_id=456&cursor=789";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
                { "Type", ((int) ListType.Subscribers).ToString() },
        ...
        {
            const string ExpectedUrl = "https://api.twitter.com/1/lists/subscribers/show.json?user_id=789&screen_name=JoeMayo&slug=test&owner_id=123&owner_screen_name=JoeMayo&list_id=456";
            var listReqProc = new ListRequestProcessor<List>() { BaseUrl = "https://api.twitter.com/1/" };
            var parameters = new Dictionary<string, string>
            {
                { "Type", ((int) ListType.IsSubscribed).ToString() },
        ...
        void TestMultipleListsResponse(ListRequestProcessor<List> listProc)
        {
            ...
            Assert.Equal("test", list.Description);
